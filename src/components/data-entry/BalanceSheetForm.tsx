      ...
      <CardContent className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                placeholder="Auto-calculated: Sum of all assets"
                disabled
              />
            </div>
          </div>
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
              <Label htmlFor="retained_earnings">Retained Earnings (can be negative)</Label>
              <Input
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                placeholder="Auto-calculated: Sum of all liabilities & equity"
                disabled
              />
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                placeholder="Asset depreciation period (1-50 years)"
              />
            </div>
