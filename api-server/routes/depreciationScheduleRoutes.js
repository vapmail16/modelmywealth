...
const depreciationScheduleController = require('../controllers/depreciationScheduleController');
...
// Validate data
router.get('/:projectId/validate', 
  projectOwnershipMiddleware, 
  depreciationScheduleController.validateData
);

// Perform calculation
router.post('/:projectId/calculate', 
  projectOwnershipMiddleware, 
  depreciationScheduleController.performCalculation
);

// Get depreciation schedule
router.get('/:projectId/schedule', 
  projectOwnershipMiddleware, 
  depreciationScheduleController.getDepreciationSchedule
);

// Get calculation history
router.get('/:projectId/history', 
  projectOwnershipMiddleware, 
  depreciationScheduleController.getCalculationHistory
);

// Restore calculation run
router.post('/:runId/restore', 
  runOwnershipMiddleware, 
  depreciationScheduleController.restoreCalculationRun
);
